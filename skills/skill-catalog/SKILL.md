...
### Manual scan
```bash
bash skills/skill-catalog/register.sh
```

### Install git hooks (one-time)
```bash
bash skills/skill-catalog/install-hooks.sh
```
...
```markdown
# Skills Index
> Auto-generated. Run `bash skills/skill-catalog/register.sh` to update.
...
```bash
find "$SKILLS_DIR" -name "SKILL.md" -not -path "*/skill-catalog/*" -not -path "*/your-private-skill/*"
```
